...
export default function () {
    ...
    return <div className="bg-slate-50 min-h-screen">
        ...
        <header className="h-14 bg-white border-b border-slate-200 flex justify-between items-center p-6">
            ...
            <Button className="bg-emerald-500 hover:bg-emerald-600 hover:text-white text-white">
                    ...
                    <Card className="rounded-md pb-0">
                        ...
                        <CardContent className="space-y-8">
                            <div className="space-y-4">
                                <div>
                                    <h2 className="text-lg font-normal text-slate-900">Company Information</h2>
                                </div>
                                <div className="">
                                    <div>
                                        ...
                                        <Input type="text" className="mt-1" {...register("companyName")} />
                                    </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h2 className="text-lg font-normal text-slate-900">Primary Contact</h2>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Input type="text" className="mt-1" {...register("contactName")} />
                                    </div>
                                    <div>
                                        <Label className="text-sm font-normal text-slate-700">
                                    ...
                                    <div>
                                        ...
                                        <Input type="text" className="mt-1" {...register("phoneNumber")} />
                                    </div>
                                    <div>
                                        <Label className="text-sm font-normal text-slate-700">
                                            Status
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h2 className="text-lg font-normal text-slate-900">Address</h2>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <Input type="text" className="mt-1" onChange={handleStreetAddress} />
                                    </div>
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <Input type="text" className="mt-1" onChange={handleCity} />
                                        </div>
                                        <div>
                                            <Label className="text-sm font-normal text-slate-700">
                                                State <span className="text-rose-500">*</span>
                                            </Label>
                                            <Input type="text" className="mt-1" onChange={handleState} />
                                        </div>
                                        <div>
                                            <Label className="text-sm font-normal text-slate-700">
                                                Postal Code <span className="text-rose-500">*</span>
                                            </Label>
                                            <Input type="text" className="mt-1" onChange={handlePostalCode} />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <Select defaultValue="india" onValueChange={handleCountary}>
                                            <SelectTrigger className="w-full mt-1">
                                            ...
                                            <SelectContent>

                                                {
                                                    countries.map((countary) => (
                                                        <SelectItem key={countary.id} id={countary.id} value={countary.value}> {countary.name} </SelectItem>
                                                    ))
                                                }
                                            </SelectContent>
                                        </Select>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h2 className="text-lg font-normal text-slate-900">Additional Information</h2>
                        ...
                        <CardFooter className="flex justify-between border-t border-slate-200 bg-slate-50 py-4">
                            ...
                            <Button className="bg-emerald-500 hover:bg-emerald-600 text-white" onClick={handleSubmit(onSubmit)}>
                                <Save className="w-4 h-4 mr-2" />
                                Save Client
                            </Button>
                        </CardFooter>
