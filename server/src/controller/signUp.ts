        ...
        if (requestValidation.success) {
            ...
            if (userExist) {
                ...
                if (userExist.isUserVerified) {
                    ...
                    res.status(409).json({ message: "User already exists with this email", success: false });
            ...
            if (!emailResponse.success) {
                ...
                res.status(201).json({ message: "User registered successfully. Please verify your email", success: true })
            }
        }
        else {
